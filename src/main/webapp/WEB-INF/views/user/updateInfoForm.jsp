	...
	<div>
		...
		<div>
			<form action="/user/auth/update" method="post">
				...
				<div class="form-group">
					<label for="birth">생일:</label> <input type="text" class="form-control" id="birth" name="birth" value="${infoList.birth}" readonly="readonly">
				</div>
				<div class="form-group">
					<label for="phone">휴대폰 번호:</label> <input type="text" class="form-control" placeholder="휴대폰 번호를 입력해주세요" id="phone" name="phone" value="${infoList.phone}">
				</div>
